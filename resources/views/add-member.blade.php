...
@section('content')
    ...
    <div id="main" class="main">
        ...
        <div class="container">
            ...
            <form action="{{ route('addfamilymember', ['id' => $parent->id]) }}" class="parent-form" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="tel" class="form-control" value="{{old('phone')}}" name="phone" id="phone" aria-describedby="phoneHelp">
                        <span>
                            @error('phone')
                                <small style="color: red;">{{ $message }}</small>
                            @enderror
                ...
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <input type="text" value="{{old('address')}}" class="form-control" name="address" id="address" aria-describedby="addressHelp">
                        <span>
                            @error('address')
                                <small style="color: red;">{{ $message }}</small>
                            @enderror
