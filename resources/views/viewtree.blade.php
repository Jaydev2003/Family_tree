...
@section('content')
    <link rel="stylesheet" href="{{ asset('tree/viewtree.css') }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function flattenData(data, parentId = null) {
                var result = [];
                data.forEach(item => {
                    var point = {
                        id: item.id,
            ...
            var points = familydata && Array.isArray(familydata) && familydata.length > 0
                ...
                annotations: [
                    {
                        position: 'bottom',
                        label_text:
                            'Click on a node to see their children or click again to hide them.'
                    }
                ],
                    ...
                    label: {
                        text: function (point) {
                            ...
                            if (isMarried) {
                                ...
                                var imageSrc = point.options('gender') === 'Male' ? maleImageSrc : femaleImageSrc;
                                return `
